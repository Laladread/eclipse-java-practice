	 ...
	 */
		public static void main(String[] args) 
		{
			...
			/**
			 ...
			 a positive number < 1000
			 return the name of the number ex. two hundred seventy four
			 */
			 ...
			 * return the name of the digit ex. one...nine
			 */
			 ...
			 * return the name of the given number ex. ten...ninteen
			 */
			 ...
			 * return the name of the tens parts of the number ex. twenty...ninety
			 */
